/*=========================================================================
  ...
  Module:    $RCSfile: itkVarianceImageFilterTest.cxx,v $
  Language:  C++
...
int main(int ac, char* av[])
{
  ...
  if(ac < 3)
    {
    std::cerr << "Usage: " << av[0] << " InputImage OutputImage Radius\n";
    return -1;
    }
  ...
  // Create a filter
  typedef itk::VarianceImageFilter<myImageIn, myImageOut> FilterType;
